...
<h3>4. HTML 4.01 (1999)</h3>

HTML 4.01 focused on improving the structure of web pages. It encouraged the use of CSS for styling and JavaScript for interactivity. This version also improved accessibility and support for multimedia content.

<h3>5. XHTML 1.0 (2000)</h3>

XHTML (Extensible HyperText Markup Language) is a stricter version of HTML based on XML rules. Every tag had to be properly closed, and the code had to follow strict syntax rules. XHTML helped developers write cleaner and more organized code.

<h3>6. HTML5 (2014 – Present)</h3>
